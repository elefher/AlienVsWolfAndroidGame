...
public class InitializeRockets {
	...
	public ArrayList<Rocket> getRockets() {
		...
		for (int i = 0; i < length; i++) {
			rocket.add(new Rocket(pixelX.get(i), pixelY.get(i), power.get(i), speedX.get(i), moveSpeed.get(i)));
		}
		return rocket;
	}
}