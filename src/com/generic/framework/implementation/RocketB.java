...
public class RocketB extends FlyObject {

	int sizeDestroyAnim, DesptroyAnimrepeats = 0;
	int totalSpeed = 0;

	public RocketB(int centerX, int centerY, int power, int speedX, int moveSpeed) {
	...
	public void setFlyobjectAnim() {
		...
		int size = Assets.rocketb.size();
		for (int i = 0; i < size; i++) {
			flyObjectAnim.addFrame((Image) Assets.rocketb.get(i), 10);
		}
	}
